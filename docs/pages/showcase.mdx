...
{<h1 className="mt-10 mb-4 text-center text-[2.5rem] font-bold tracking-tight">案例</h1>}

{<p className="mb-16 text-center text-lg text-gray-500 dark:text-gray-400">由 Nextra 驱动的开源项目</p>}
